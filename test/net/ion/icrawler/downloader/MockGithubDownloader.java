...
public class MockGithubDownloader implements Downloader {
	...
	private String html = "\n"
			...
			+ "\n"
			+ "<div class=\"highlight highlight-java\"><pre>    <span class=\"kd\">public</span> <span class=\"kd\">class</span> <span class=\"nc\">TistoryBlogPageProcessor</span> <span class=\"kd\">implements</span> <span class=\"n\">PageProcessor</span> <span class=\"o\">{</span>\n"
			+ "\n"
			...
			+ "            <span class=\"n\">Spider</span><span class=\"o\">.</span><span class=\"na\">create</span><span class=\"o\">(</span><span class=\"k\">new</span> <span class=\"n\">TistoryBlogPageProcessor</span><span class=\"o\">())</span>\n"
			...
			+ "    <span class=\"kd\">public</span> <span class=\"kd\">class</span> <span class=\"nc\">TistoryBlog</span> <span class=\"o\">{</span>\n"
			+ "\n"
			...
			+ "                <span class=\"k\">new</span> <span class=\"nf\">ConsolePageModelPipeline</span><span class=\"o\">(),</span> <span class=\"n\">TistoryBlog</span><span class=\"o\">.</span><span class=\"na\">class</span><span class=\"o\">).</span><span class=\"na\">run</span><span class=\"o\">();</span>\n"
			+ "        <span class=\"o\">}</span>\n"
			+ "    <span class=\"o\">}</span>\n"
			+ "</pre></div>\n"
			+ "\n"
