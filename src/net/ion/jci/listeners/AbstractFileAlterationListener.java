...
public abstract class AbstractFileAlterationListener implements FileAlterationListener {

    private final Log log = LogFactory.getLog(AbstractFileAlterationListener.class);
