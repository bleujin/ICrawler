...
public class XPathParser {
	...
	/**
	 * EvaluatorStack for logic calculate. Priority: AND > OR, Regardless of bracket.
	 * <p/>
	 * Calculate AND immediately. Store evaluator with OR, until there are two evaluator in stack, then calculate it.
	 */
